...
if(isset($_REQUEST['save']))
{
  ...
  //end of of varibale and value setting
	...
	$query = "INSERT INTO `basic_details`(`user_code`,`name`,`address`,`email`,`mobile`,`profile`,`objective`,`declaration`)
  VALUES('$user_code','$name','$address','$email','$mobile','$profile','$objective','$declaration')";  
