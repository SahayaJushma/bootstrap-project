...
<!--start of header name-->
 <h1 class="h3 mb-4 text-gray-800">EXPERIENCE DETAILS</h1>
         <?php 
...
<div class="container">
  ...
  <td>
   <input type="experience" name="experience" class="form-control" value="<?php if($action=="edit"){ echo $data['experience'];} else { echo "";} ?>" required="required">
   </td>
  </tr>
  <tr>
  <td align="right"><b>role<b></td>
  <td>
   <input type="role" name="role" class="form-control" value="<?php if($action=="edit"){ echo $data['role'];} else { echo "";} ?>"  required="required">
   </td>
  </tr>
  <tr>
