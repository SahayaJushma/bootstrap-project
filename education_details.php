...
<!--start of header name-->
 <h1 class="h3 mb-4 text-gray-800">EDUCATION DETAILS</h1>
         <?php 
...
if(isset($_REQUEST['save']))
{
  ...
  //end of of varibale and value setting
	...
	$query = "INSERT INTO `education_details`(`user_code`,`coursename`,`university`,`college`,`passyear`,`percentage`)VALUES('$user_code','$coursename','$university','$college','$passyear','$percentage')";  
...
<div class="container">
  ...
  <td>
   <input type="coursename" name="coursename" class="form-control" value="<?php if($action=="edit"){ echo $data['coursename'];} else { echo "";} ?>" required="required">
   </td>
  </tr>
  <tr>
  <td align="right"><b>university <b></td>
  <td>
   <input type="university" name="university" class="form-control" value="<?php if($action=="edit"){ echo $data['university'];} else { echo "";} ?>"  required="required">
   </td>
  </tr>
  <tr>
  <td align="right"><b>college<b></td>
  <td>
   <input type="college " name="college" class="form-control" value="<?php if($action=="edit"){ echo $data['college'];} else { echo "";} ?>"  required="required">
   </td>
  </tr>
  <tr>
